...
public class Gui extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        stage.setTitle("Figurer Opgave 2");
    ...
    private void drawShapes(Pane pane)
    {
        ...
        Circle circ1 = new Circle(offsetX+30, 100, 30);
        Rectangle rect1 = new Rectangle(offsetX, 200, 100, 50);
        Line line1 = new Line(offsetX, 300, 300, 300);

        pane.getChildren().add(circ1);
        pane.getChildren().add(rect1);
        pane.getChildren().add(line1);

        circ1.setFill(Paint.valueOf(yellow));
        rect1.setFill(Paint.valueOf(yellow));
        line1.setStroke(Paint.valueOf(yellow));
