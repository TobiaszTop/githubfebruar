...
public class Gui extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        stage.setTitle("Figurer Opgave 1");
    ...
    private void drawShapes(Pane pane)
    {
        ...
        Circle circ1 = new Circle(30, 100, 30);
        Rectangle rect1 = new Rectangle(0, 200, 100, 50);
        Line line1 = new Line(0, 300, 300, 300);
